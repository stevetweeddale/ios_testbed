 ...
 */
function ios_testbed_profile_modules() {
  $modules = array(
     // Drupal core.
    'block',
    'book',
 ...
 */
function ios_testbed_profile_details() {
  return array(
    'name' => 'IOS Testbed',
    'description' => 'Set up a site for testing services for IOS.'
  );
}
 ...
 */
function ios_testbed_profile_tasks(&$task, $url) {
  ...
  ios_testbed_enable_theme('rubik');
}

/**
 * Implementation of hook_form_alter()
 */
function ios_testbed_form_alter(&$form, $form_state, $form_id) {
  if ($form_id == 'install_configure') {
    $form['site_information']['site_name']['#default_value']    = 'IOS Testbed';
  }
}
 ...
 */
function ios_testbed_enable_theme($theme_name, $profile_name = 'ios_testbed') {
  ...
  // profile directory.
  _ios_testbed_system_theme_data($profile_name);
 ...
 */
function _ios_testbed_system_theme_data($profile_name) {
  global $profile;
